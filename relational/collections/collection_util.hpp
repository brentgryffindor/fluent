#ifndef COLLECTIONS_COLLECTION_UTIL_HPP_
#define COLLECTIONS_COLLECTION_UTIL_HPP_
...
//
//   CollectionTypes<Table<Keys<Ks...>, Ts...>> == <Ts...>
...
struct CollectionTypes<Table<Keys<Ks...>, Ts...>> {
...
//
//   template <std::size_t... Ks, typename... Ts>
//   bool is_templated(const Table<Keys<Ks...>, Ts...>&) {
//     return true;
//   }
//
//   template <typename... Ts>
...
template <std::size_t... Ks, typename... Ts>
struct GetCollectionType<Table<Keys<Ks...>, Ts...>>
...
#endif  // COLLECTIONS_COLLECTION_UTIL_HPP_